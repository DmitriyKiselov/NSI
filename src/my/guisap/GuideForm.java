 ...
 * @author DaN
 */
public class GuideForm extends javax.swing.JDialog {
    ...
    public GuideForm(boolean modal, String atnam, String atprt, String atinn, String classFlag, String atbez, boolean bListFlag) {//BlackList
        super(MainClass.mainWindow, modal);
        setVariables(atprt, atinn, atnam, classFlag);
        this.atbez = atbez;
        callFromBlackList = true;
        initComponents();
    ...
    public GuideForm(boolean modal, String atnam, String atprt, String atinn, String classFlag, String atbez) {//Scala
        super(MainClass.mainWindow, modal);
        setVariables(atprt, atinn, atnam, classFlag);
        this.atbez = atbez;
        callScalaLoader = true;
        initComponents();
        signsFormation(atprt, atinn, atnam, classFlag);
        jTextField2.requestFocus();
        jButton3.setEnabled(false);
